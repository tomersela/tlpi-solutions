...
## Testing
```
> ./mylogger -p info "Testing 1, 2..."        
> ./mylogger -p local3.notice "Check this out"
> ./mylogger "Default priority: user.notice"  
> ./mylogger -p err "Mayday"                  
> journalctl -q -t mylogger
May 04 00:04:29 debian mylogger[28681]: Testing 1, 2...
May 04 00:04:35 debian mylogger[28716]: Check this out
May 04 00:04:38 debian mylogger[28751]: Default priority: user.notice
May 04 00:04:41 debian mylogger[28792]: Mayday
> journalctl -q --output cat --output-fields=MESSAGE,PRIORITY -t mylogger
6
Testing 1, 2...
5
Check this out
5
Default priority: user.notice
3
Mayday
```

...
## Testing
```bash
> touch /mnt/ext4-drive/testfile     
> chmod u+x,g+rwx /mnt/ext4-drive/testfile
> setfacl -m user:debian:rw- /mnt/ext4-drive/testfile
> setfacl -m group:debian:r-x /mnt/ext4-drive/testfile
> setfacl -m user:tomersela:rwx /mnt/ext4-drive/testfile
> setfacl -m group:tomersela:--- /mnt/ext4-drive/testfile
> setfacl -m mask::rw- /mnt/ext4-drive/testfile
> ll /mnt/ext4-drive/testfile
-rwxrw-r--+ 1 debian debian 0 Dec 24 02:15 /mnt/ext4-drive/testfile
> getfacl -a /mnt/ext4-drive/testfile
getfacl: Removing leading '/' from absolute path names
# file: mnt/ext4-drive/testfile
# owner: debian
# group: debian
user::rwx
user:debian:rw-
user:tomersela:rwx		#effective:rw-
group::rwx			#effective:rw-
group:debian:r-x		#effective:r--
group:tomersela:---
mask::rw-
other::r--

> # Test owner permissions
> ./show_acl u debian /mnt/ext4-drive/testfile
rwx
> # Test user ACL entry (w/ masking)
> ./show_acl u tomersela /mnt/ext4-drive/testfile
rw-
> # Test group permissions (w/ masking)
> ./show_acl g debian /mnt/ext4-drive/testfile
rw-
> # Test fallback to 'other'
> ./show_acl g tomersela /mnt/ext4-drive/testfile
r--
```

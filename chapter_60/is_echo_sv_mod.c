...
/* is_echo_sv_mod.c
   ...
   An implementation of the TCP "echo" service with semaphore-based
   connection limiting to maximum 10 concurrent connections.
...
main(int argc, char *argv[])
{
    ...
    for (;;) {
        ...
        if (cfd == -1) {
            ...
            sem_post(&sem);  /* Release semaphore on accept failure */
            exit(EXIT_FAILURE);
        }
        ...
        case -1:
            ...
            sem_post(&sem);             /* Restore semaphore count */

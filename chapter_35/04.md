...
## Testing
Running both processes on the same CPU is faster then running on different CPUs

```
> ./cpu_affinity 0 0 
Parent on CPU 0, Child on CPU 0
Parent CPU 0, Child CPU 0: Time to transfer 500MB = 0.504410 seconds
> ./cpu_affinity 0 1
Parent on CPU 0, Child on CPU 1
Parent CPU 0, Child CPU 1: Time to transfer 500MB = 2.101128 seconds
```
